...
{
    /// <summary>
    /// Reads substance data
    /// </summary>
    public class SubstanceDataReader
    {
        private Dictionary<String, Substance> substanceDictionary = new Dictionary<String, Substance>();
        
		public Dictionary<string, Substance> DrugDictionary {
			get { return this.substanceDictionary; }
			set { this.substanceDictionary = value; }
		}

        /// <summary>
        /// Reads substance information from an XML file and adds it to the substanceDictionary
        /// </summary>
        /// <param name="fileName">The XML file to parse</param>
        public void GetSubstanceInfo(string fileName)
        {
            ...
            foreach (XmlNode node in document.GetElementsByTagName("drug"))
            {
                                ...
                                switch (attrNode.Attributes["key"].InnerText.ToLower())
                                {
                                   case "oral":
                                    ...
                                    case "ld50":
                                        ...
                                        break;
                                    case "naiveoraldose":
                                        d.NaiveOralDose = double.Parse(value);
                                        break;
                                    case "naiveivdose":
                                        d.NaiveIVDose = double.Parse(value);
                                        break;
                                    case "description":
                                        d.Description = value;
                                        break;
               ...
               this.substanceDictionary.Add(d.Name, d);
            }
